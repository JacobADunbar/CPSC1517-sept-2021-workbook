...
namespace PracticeConsole.Data
{
    public class Employment
    {
        ...
        public static bool TryParse(string text, out Employment result)
        {
            ...
            //If the parsing is succeful, we will set the out variable to the parsed instance and change the valid flag to true
            //If the parsing is not successful, we will set the out variable to null and noty change the valid flag
            try
            {
                result = Parse(text);
                valid = true;
